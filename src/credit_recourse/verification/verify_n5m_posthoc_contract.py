...
"""Verify the canonical N5M matched-budget post-hoc output contract."""
...
from credit_recourse.verification.verify_paper_repro_output_contract import _verify_n5m_posthoc

SCHEMA_VERSION = "n5m_posthoc_contract_v4"
...
def verify(project_root: Path, analysis_dir: Path | None = None) -> dict:
    ...
    detail = _verify_n5m_posthoc(layout, errors)
    return {
